...
class DichVuSeeder extends Seeder
{
    ...
    {
        DB::statement('SET FOREIGN_KEY_CHECKS=0;'); // Tắt foreign key checks
        DB::table('dich_vus')->truncate(); // Thực hiện truncate
        DB::statement('SET FOREIGN_KEY_CHECKS=1;'); // Bật lại foreign key checks
